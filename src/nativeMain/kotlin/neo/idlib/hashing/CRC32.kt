...
class CRC32 {
    ...
    fun make_crc_table() {
        ...
        val p = byteArrayOf(0, 1, 2, 4, 5, 7, 8, 10, 11, 12, 16, 22, 23, 26)

        /* make exclusive-or pattern from polynomial (0xedb88320L) */poly = 0L
        i = 0
        while (i < p.size) {
            poly = poly or (1L shl 31 - p[i])
            i++
        }
        i = 0
        while (i < 256) {
    ...
    companion object {
        const val CRC32_INIT_VALUE = 0xffffffffL
        const val CRC32_XOR_VALUE = 0xffffffffL
