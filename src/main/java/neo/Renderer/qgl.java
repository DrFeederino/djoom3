...
//    // multitexture
    ...
    public static void qglGenBuffersARB(int n, IntBuffer[] buffers) {
...
//extern	void ( APIENTRY *qglCombinerParameterfNV )( GLenum pName, const GLfloat param );
    public static void qglCombinerParameteriNV(int pName, final int param) {
...
//        NVRegisterCombiners.glFinalCombinerInputNV(variable, input, mapping, componentUsage);
    ...
    // 3D textures
    public static void qglTexImage3D(int GLenum1, int GLint1, int GLint2, int GLsizei1, int GLsizei2, int GLsizei3, int GLint4, int GLenum2, int GLenum3, ByteBuffer GLvoid) {
...
//extern	PFNGLSTENCILFUNCSEPARATEATIPROC		qglStencilFuncSeparateATI;
    ...
    public static void    /*PFNGLCOMPRESSEDTEXIMAGE2DARBPROC*/    qglCompressedTexImage2DARB(int target, int level, int internalformat,
                                                                                             int width, int height, int border, int imageSize, final ByteBuffer data) {
...
//        ARBTextureCompression.glCompressedTexImage2DARB(target, level, internalformat, width, height, border, data);
    ...
    public static void /*PFNGLGETCOMPRESSEDTEXIMAGEARBPROC*/ qglGetCompressedTexImageARB(int target, int index, ByteBuffer img) {
...
//        GL20.glVertexAttribPointer(index, size, normalized, stride, FloatBuffer.wrap(pointer));
    ...
    public static  /*PFNGLPROGRAMSTRINGARBPROC*/void qglProgramStringARB(int target, int format, int len, final ByteBuffer string) {
...
//
    ...
    public static /*PFNGLPROGRAMENVPARAMETER4FVARBPROC*/ void qglProgramEnvParameter4fvARB(int target, Enum index, final FloatBuffer params) {
        DEBUG_printName("glProgramEnvParameter4fvARB");
        ARBVertexProgram.glProgramEnvParameter4fvARB(target, index.ordinal(), params);
    }

    //    @Deprecated
    public static /*PFNGLPROGRAMENVPARAMETER4FVARBPROC*/ void qglProgramEnvParameter4fvARB(int target, Enum index, final float[] params) {
    ...
    //    @Deprecated
    public static /*PFNGLPROGRAMENVPARAMETER4FVARBPROC*/ void qglProgramEnvParameter4fvARB(int target, int index, final float[] params) {
        DEBUG_printName("glProgramEnvParameter4fvARB");//TODO:convert calls to floatbuffer
        ARBVertexProgram.glProgramEnvParameter4fvARB(target, index, params);
//        qglProgramEnvParameter4fvARB(target, index, wrap(params));
    }

    public static /*PFNGLPROGRAMENVPARAMETER4FVARBPROC*/ void qglProgramEnvParameter4fvARB(int target, int index, final FloatBuffer params) {
        DEBUG_printName("glProgramEnvParameter4fvARB");
        ARBVertexProgram.glProgramEnvParameter4fvARB(target, index, params);
    }

    public static /*PFNGLPROGRAMLOCALPARAMETER4FVARBPROC*/ void qglProgramLocalParameter4fvARB(int target, int index, final FloatBuffer params) {
...
//    }
    ...
    public static boolean qglAreTexturesResident(int n, IntBuffer textures, ByteBuffer residences) {
...
//        System.out.printf("qglBindTexture(%d, %d)\n", target, texture);
    ...
    public static void qglBitmap(int width, int height, float xorig, float yorig, float xmove, float ymove, ByteBuffer bitmap) {
...
//        GL11.glCallLists(lists);
    ...
    public static void qglColor3bv(byte[] v) {
    ...
    public static void qglColor3dv(double[] v) {
    ...
    public static void qglColor3iv(int[] v) {
    ...
    public static void qglColor3sv(short[] v) {
    ...
    public static void qglColor3uiv(int[] v) {
    ...
    public static void qglColor3usv(short[] v) {
    ...
    public static void qglColor4bv(byte[] v) {
    ...
    public static void qglColor4dv(double[] v) {
    ...
    public static void qglColor4iv(int[] v) {
    ...
    public static void qglColor4sv(short[] v) {
    ...
    public static void qglColor4uiv(int[] v) {
        DEBUG_printName("glColor4uiv");
        throw new UnsupportedOperationException("Not supported yet.");
    }

    public static void qglColor4usv(short[] v) {
    ...
    @Deprecated
    public static void qglColorPointer(int size, int type, int stride, Object pointer) {
        DEBUG_printName("glColorPointer");
//        GL11.glColorPointer(size, type, stride, );
    ...
    public static void qglCopyTexImage2D(int target, int level, int internalFormat, int x, int y, int width, int height, int border) {
    ...
    public static void qglCopyTexSubImage2D(int target, int level, int xoffset, int yoffset, int x, int y, int width, int height) {
    ...
    public static void qglDeleteTextures(int n, int[] textures) {
        DEBUG_printName("glDeleteTextures");
//        GL11.glDeleteTextures();
    ...
    public static void qglEdgeFlagPointer(int stride, Object pointer) {
        DEBUG_printName("glEdgeFlagPointer");
//        GL11.glEdgeFlagPointer(stride, );
        throw new UnsupportedOperationException("Not supported yet.");
    }

    public static void qglEdgeFlagv(boolean flag) {
...
//        System.out.println("--"+cap);
    ...
    public static void qglEvalCoord1dv(double[] u) {
    ...
    public static void qglEvalCoord1fv(float[] u) {
    ...
    public static void qglEvalCoord2dv(double[] u) {
    ...
    public static void qglEvalCoord2fv(float[] u) {
    ...
    public static void qglFogfv(int pName, float[] params) {
    ...
    public static void qglFogiv(int pName, int[] params) {
    ...
    public static int qglGenLists(int range) {
...
//        TempDump.printCallStack("" + (bla++));
    ...
    public static void qglGenTextures(int n, int[] textures) {
        DEBUG_printName("glGenTextures");
        GL11.glGenTextures();
    }

    public static void qglGetBooleanv(int pName, boolean[] params) {
    ...
    public static void qglGetDoublev(int pName, double[] params) {
    ...
    public static void qglGetLightfv(int light, int pName, float[] params) {
        DEBUG_printName("glGetLightfv");
        throw new UnsupportedOperationException("Not supported yet.");
    }

    public static void qglGetLightiv(int light, int pName, int[] params) {
        DEBUG_printName("glGetLightiv");
        throw new UnsupportedOperationException("Not supported yet.");
    }

    public static void qglGetMapdv(int target, int query, double[] v) {
        DEBUG_printName("glGetMapdv");
        throw new UnsupportedOperationException("Not supported yet.");
    }

    public static void qglGetMapfv(int target, int query, float[] v) {
        DEBUG_printName("glGetMapfv");
        throw new UnsupportedOperationException("Not supported yet.");
    }

    public static void qglGetMapiv(int target, int query, int[] v) {
        DEBUG_printName("glGetMapiv");
        throw new UnsupportedOperationException("Not supported yet.");
    }

    public static void qglGetMaterialfv(int face, int pName, float[] params) {
        DEBUG_printName("glGetMaterialfv");
        throw new UnsupportedOperationException("Not supported yet.");
    }

    public static void qglGetMaterialiv(int face, int pName, int[] params) {
        DEBUG_printName("glGetMaterialiv");
        throw new UnsupportedOperationException("Not supported yet.");
    }

    public static void qglGetPixelMapfv(int map, float[] values) {
        DEBUG_printName("glGetPixelMapfv");
//        GL11.glGetPixelMapfv(map, );
        throw new UnsupportedOperationException("Not supported yet.");
    }

    public static void qglGetPixelMapuiv(int map, int[] values) {
        DEBUG_printName("glGetPixelMapuiv");
//        GL11.glGetPixelMapuiv(map, );
        throw new UnsupportedOperationException("Not supported yet.");
    }

    public static void qglGetPixelMapusv(int map, short[] values) {
        DEBUG_printName("glGetPixelMapusv");
//        GL11.glGetPixelMapusv(map, );
        throw new UnsupportedOperationException("Not supported yet.");
    }

    public static void qglGetPointerv(int pName, Object[] params) {
        DEBUG_printName("glGetPointerv");
        throw new UnsupportedOperationException("Not supported yet.");
    }

    public static void qglGetPolygonStipple(byte mask) {
...
//        GL11.glGetPolygonStipple();
    ...
    public static void qglGetTexEnvfv(int target, int pName, float[] params) {
        DEBUG_printName("glGetTexEnvfv");
        throw new UnsupportedOperationException("Not supported yet.");
    }

    public static void qglGetTexEnviv(int target, int pName, int[] params) {
        DEBUG_printName("glGetTexEnviv");
        throw new UnsupportedOperationException("Not supported yet.");
    }

    public static void qglGetTexGendv(int coord, int pName, double[] params) {
        DEBUG_printName("glGetTexGendv");
        throw new UnsupportedOperationException("Not supported yet.");
    }

    public static void qglGetTexGenfv(int coord, int pName, float[] params) {
        DEBUG_printName("glGetTexGenfv");
        throw new UnsupportedOperationException("Not supported yet.");
    }

    public static void qglGetTexGeniv(int coord, int pName, int[] params) {
    ...
    public static void qglGetTexLevelParameterfv(int target, int level, int pName, float[] params) {
        DEBUG_printName("glGetTexLevelParameterfv");
        throw new UnsupportedOperationException("Not supported yet.");
    }

    public static void qglGetTexLevelParameteriv(int target, int level, int pName, int[] params) {
        DEBUG_printName("glGetTexLevelParameteriv");
        throw new UnsupportedOperationException("Not supported yet.");
    }

    public static void qglGetTexParameterfv(int target, int pName, float[] params) {
        DEBUG_printName("glGetTexParameterfv");
        throw new UnsupportedOperationException("Not supported yet.");
    }

    public static void qglGetTexParameteriv(int target, int pName, int[] params) {
        DEBUG_printName("glGetTexParameteriv");
        throw new UnsupportedOperationException("Not supported yet.");
    }

    public static void qglHint(int target, int mode) {
    ...
    public static void qglIndexPointer(int type, int stride, Object pointer) {
        DEBUG_printName("glIndexPointer");
        throw new UnsupportedOperationException("Not supported yet.");
    }

    public static void qglIndexd(double c) {
        DEBUG_printName("glIndexd");
        throw new UnsupportedOperationException("Not supported yet.");
    }

    public static void qglIndexdv(double[] c) {
        DEBUG_printName("glIndexdv");
        throw new UnsupportedOperationException("Not supported yet.");
    }

    public static void qglIndexf(float c) {
        DEBUG_printName("glIndexf");
        throw new UnsupportedOperationException("Not supported yet.");
    }

    public static void qglIndexfv(float[] c) {
        DEBUG_printName("glIndexfv");
        throw new UnsupportedOperationException("Not supported yet.");
    }

    public static void qglIndexi(int c) {
        DEBUG_printName("glIndexi");
        throw new UnsupportedOperationException("Not supported yet.");
    }

    public static void qglIndexiv(int[] c) {
        DEBUG_printName("glIndexiv");
        throw new UnsupportedOperationException("Not supported yet.");
    }

    public static void qglIndexs(short c) {
        DEBUG_printName("glIndexs");
        throw new UnsupportedOperationException("Not supported yet.");
    }

    public static void qglIndexsv(short[] c) {
        DEBUG_printName("glIndexsv");
        throw new UnsupportedOperationException("Not supported yet.");
    }

    public static void qglIndexub(byte c) {
        DEBUG_printName("glIndexub");
        throw new UnsupportedOperationException("Not supported yet.");
    }

    public static void qglIndexubv(byte[] c) {
    ...
    public static void qglLogicOp(int opcode) {
    ...
    public static void qglMap2d(int target, double u1, double u2, int ustride, int uorder, double v1, double v2, int vstride, int vorder, DoubleBuffer points) {
        DEBUG_printName("glMap2d");
        GL11.glMap2d(target, u1, u2, ustride, uorder, v1, v2, vstride, vorder, points);
    }

    public static void qglMap2f(int target, float u1, float u2, int ustride, int uorder, float v1, float v2, int vstride, int vorder, FloatBuffer points) {
        DEBUG_printName("glMap2f");
        GL11.glMap2f(target, u1, u2, ustride, uorder, v1, v2, vstride, vorder, points);
    }

    public static void qglMapGrid1d(int un, double u1, double u2) {
        DEBUG_printName("glMapGrid1d");
        GL11.glMapGrid1d(un, u1, u2);
    }

    public static void qglMapGrid1f(int un, float u1, float u2) {
    ...
    public static void qglMaterialfv(int face, int pName, float[] params) {
    ...
    public static void qglMaterialiv(int face, int pName, int[] params) {
    ...
    public static void qglMultMatrixd(double[] m) {
        DEBUG_printName("glMultMatrixd");
        throw new UnsupportedOperationException("Not supported yet.");
    }

    public static void qglMultMatrixf(float[] m) {
        DEBUG_printName("glMultMatrixf");
        throw new UnsupportedOperationException("Not supported yet.");
    }

    public static void qglNewList(int list, int mode) {
    ...
    public static void qglNormal3bv(byte[] v) {
    ...
    public static void qglNormal3dv(double[] v) {
    ...
    public static void qglNormal3fv(float[] v) {
    ...
    public static void qglNormal3iv(int[] v) {
    ...
    public static void qglNormal3sv(short[] v) {
    ...
    public static void qglPixelMapfv(int map, int mapsize, float[] values) {
        DEBUG_printName("glPixelMapfv");
        throw new UnsupportedOperationException("Not supported yet.");
    }

    public static void qglPixelMapuiv(int map, int mapsize, int[] values) {
        DEBUG_printName("glPixelMapuiv");
        throw new UnsupportedOperationException("Not supported yet.");
    }

    public static void qglPixelMapusv(int map, int mapsize, short[] values) {
    ...
    public static void qglPolygonStipple(ByteBuffer mask) {
    ...
    public static void qglPrioritizeTextures(int n, IntBuffer textures, FloatBuffer priorities) {
        DEBUG_printName("glPrioritizeTextures");
    ...
    public static void qglRasterPos2dv(double[] v) {
    ...
    public static void qglRasterPos2fv(float[] v) {
    ...
    public static void qglRasterPos2iv(int[] v) {
    ...
    public static void qglRasterPos2sv(short[] v) {
    ...
    public static void qglRasterPos3dv(double[] v) {
    ...
    public static void qglRasterPos3fv(float[] v) {
    ...
    public static void qglRasterPos3iv(int[] v) {
    ...
    public static void qglRasterPos3sv(short[] v) {
    ...
    public static void qglRasterPos4dv(double[] v) {
    ...
    public static void qglRasterPos4fv(float[] v) {
    ...
    public static void qglRasterPos4iv(int[] v) {
    ...
    public static void qglRasterPos4sv(short[] v) {
    ...
    public static void qglRectdv(double[] v1, double[] v2) {
    ...
    public static void qglRectfv(float[] v1, float[] v2) {
    ...
    public static void qglRectiv(int[] v1, int[] v2) {
    ...
    public static void qglRectsv(short[] v1, short[] v2) {
    ...
    public static void qglSelectBuffer(int size, IntBuffer buffer) {
    ...
    public static void qglTexCoord1dv(double[] v) {
    ...
    public static void qglTexCoord1fv(float[] v) {
    ...
    public static void qglTexCoord1iv(int[] v) {
    ...
    public static void qglTexCoord1sv(short[] v) {
    ...
    public static void qglTexCoord2dv(double[] v) {
    ...
    public static void qglTexCoord2iv(int[] v) {
    ...
    public static void qglTexCoord2sv(short[] v) {
    ...
    public static void qglTexCoord3dv(double[] v) {
    ...
    public static void qglTexCoord3fv(float[] v) {
    ...
    public static void qglTexCoord3iv(int[] v) {
    ...
    public static void qglTexCoord3sv(short[] v) {
    ...
    public static void qglTexCoord4dv(double[] v) {
    ...
    public static void qglTexCoord4fv(float[] v) {
    ...
    public static void qglTexCoord4iv(int[] v) {
    ...
    public static void qglTexCoord4sv(short[] v) {
...
//        GL11.glTexCoordPointer(size, stride, FloatBuffer.wrap(pointer));
    ...
    public static void qglTexEnviv(int target, int pName, int[] params) {
    ...
    public static void qglTexGendv(int coord, int pName, double[] params) {
    ...
    public static void qglTexGeniv(int coord, int pName, int[] params) {
        DEBUG_printName("glTexGeniv");
        throw new UnsupportedOperationException("Not supported yet.");
    }

    public static void qglTexImage1D(int target, int level, int internalformat, int width, int border, int format, int type, ByteBuffer pixels) {
        DEBUG_printName("glTexImage1D");
        GL11.glTexImage1D(target, level, internalformat, width, border, format, type, pixels);
    }

    @Deprecated
    public static void qglTexImage2D(int target, int level, int internalformat, int width, int height, int border, int format, int type, byte[] pixels) {
        DEBUG_printName("glTexImage2D");
        qglTexImage2D(target, level, internalformat, width, height, border, format, type, wrap(pixels));
        throw new UnsupportedOperationException();
    }

    public static void qglTexImage2D(int target, int level, int internalformat, int width, int height, int border, int format, int type, ByteBuffer pixels) {
        DEBUG_printName("glTexImage2D");
    ...
    public static void qglTexParameteriv(int target, int pName, int[] params) {
        DEBUG_printName("glTexParameteriv");
        throw new UnsupportedOperationException("Not supported yet.");
    }

    public static void qglTexSubImage1D(int target, int level, int xoffset, int width, int format, int type, ByteBuffer pixels) {
        DEBUG_printName("glTexSubImage1D");
        GL11.glTexSubImage1D(target, level, xoffset, width, format, type, pixels);
    }

    public static void qglTexSubImage2D(int target, int level, int xoffset, int yoffset, int width, int height, int format, int type, ByteBuffer pixels) {
    ...
    public static void qglVertex2dv(double[] v) {
    ...
    public static void qglVertex2fv(float[] v) {
    ...
    public static void qglVertex2iv(int[] v) {
    ...
    public static void qglVertex2sv(short[] v) {
    ...
    public static void qglVertex3dv(double[] v) {
