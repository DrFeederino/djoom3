...
object SysCvar {
    ...
    val aas_showFlyPath: idCVar? = idCVar("aas_showFlyPath", "0", CVarSystem.CVAR_GAME or CVarSystem.CVAR_INTEGER, "")
    val aas_showHideArea: idCVar? = idCVar("aas_showHideArea", "0", CVarSystem.CVAR_GAME or CVarSystem.CVAR_INTEGER, "")
    ...
    //
    val aas_showWallEdges: idCVar? = idCVar("aas_showWallEdges", "0", CVarSystem.CVAR_GAME or CVarSystem.CVAR_BOOL, "")
    ...
    val af_jointFrictionScale: idCVar? =
        idCVar("af_jointFrictionScale", "0", CVarSystem.CVAR_GAME or CVarSystem.CVAR_FLOAT, "scales the joint friction")
    ...
    val af_maxLinearVelocity: idCVar? =
        idCVar("af_maxLinearVelocity", "128", CVarSystem.CVAR_GAME or CVarSystem.CVAR_FLOAT, "maximum linear velocity")
    ...
    val af_showPrimaryOnly: idCVar? =
        idCVar("af_showPrimaryOnly", "0", CVarSystem.CVAR_GAME or CVarSystem.CVAR_BOOL, "show primary constraints only")
    val af_showTimings: idCVar? =
        idCVar("af_showTimings", "0", CVarSystem.CVAR_GAME or CVarSystem.CVAR_BOOL, "show articulated figure cpu usage")
    ...
    val af_showVelocity: idCVar? =
        idCVar("af_showVelocity", "0", CVarSystem.CVAR_GAME or CVarSystem.CVAR_BOOL, "show the velocity of each body")
    ...
    val af_useSymmetry: idCVar? =
        idCVar("af_useSymmetry", "1", CVarSystem.CVAR_GAME or CVarSystem.CVAR_BOOL, "use constraint matrix symmetry")
    ...
    val g_editEntityMode: idCVar? = idCVar(
     ...
     6 = entity names
     7 = entity models
     """.trimIndent(), 0, 7, ArgCompletion_Integer(0, 7)
    )
    ...
    //
    val g_password: idCVar? = idCVar("g_password", "", CVarSystem.CVAR_GAME or CVarSystem.CVAR_ARCHIVE, "game password")
    ...
    val g_testModelBlend: idCVar? =
        idCVar("g_testModelBlend", "0", CVarSystem.CVAR_GAME or CVarSystem.CVAR_INTEGER, "number of frames to blend")
    val g_testModelRotate: idCVar? = idCVar("g_testModelRotate", "0", CVarSystem.CVAR_GAME, "test model rotation speed")
    ...
    val g_vehicleForce: idCVar? = idCVar("g_vehicleForce", "50000", CVarSystem.CVAR_GAME or CVarSystem.CVAR_FLOAT, "")
    ...
    val gamedate: idCVar? = idCVar("gamedate", SysCvar.__DATE__, CVarSystem.CVAR_GAME or CVarSystem.CVAR_ROM, "")
    ...
    val ik_debug: idCVar? = idCVar("ik_debug", "0", CVarSystem.CVAR_GAME or CVarSystem.CVAR_BOOL, "show IK debug lines")
    ...
    val password: idCVar? =
        idCVar("password", "", CVarSystem.CVAR_GAME or CVarSystem.CVAR_NOCHEAT, "client password used when connecting")
    ...
    val pm_bobpitch: idCVar? =
        idCVar("pm_bobpitch", "0.002", CVarSystem.CVAR_GAME or CVarSystem.CVAR_NETWORKSYNC or CVarSystem.CVAR_FLOAT, "")
    val pm_bobroll: idCVar? =
        idCVar("pm_bobroll", "0.002", CVarSystem.CVAR_GAME or CVarSystem.CVAR_NETWORKSYNC or CVarSystem.CVAR_FLOAT, "")
    val pm_bobup: idCVar? =
        idCVar("pm_bobup", "0.005", CVarSystem.CVAR_GAME or CVarSystem.CVAR_NETWORKSYNC or CVarSystem.CVAR_FLOAT, "")
    ...
    val pm_runpitch: idCVar? =
        idCVar("pm_runpitch", "0.002", CVarSystem.CVAR_GAME or CVarSystem.CVAR_NETWORKSYNC or CVarSystem.CVAR_FLOAT, "")
    val pm_runroll: idCVar? =
        idCVar("pm_runroll", "0.005", CVarSystem.CVAR_GAME or CVarSystem.CVAR_NETWORKSYNC or CVarSystem.CVAR_FLOAT, "")
     ...
     */
    val si_gameTypeArgs: Array<String?>? = arrayOf("singleplayer", "deathmatch", "Tourney", "Team DM", "Last Man", null)
    val si_gameType: idCVar? = idCVar(
        "si_gameType",
        SysCvar.si_gameTypeArgs[0],
        ...
        SysCvar.si_gameTypeArgs,
        ArgCompletion_String(SysCvar.si_gameTypeArgs)
    )
    ...
    init {
        if (SysCvar._DEBUG) {
            SysCvar.BUILD_DEBUG = "-debug"
        } else {
            SysCvar.BUILD_DEBUG = "-release"
        }
    }
}