...
object Bounds {
        ...
        while (i < 3) {
            ...
            if (v1.oGet(i) > 0.0f && v2.oGet(i) < 0.0f || v1.oGet(i) < 0.0f && v2.oGet(i) > 0.0f) {
                if (0.5f * (start.oGet(i) + end.oGet(i)) - origin.oGet(i) > 0.0f) {
                    bounds.oSet(0, i, Lib.Companion.Min(start.oGet(i), end.oGet(i)))
                    ...
                    bounds.oSet(1, i, Lib.Companion.Max(start.oGet(i), end.oGet(i)))
                }
    ...
    class idBounds : SERiAL {
        ...
        private val b: Array<idVec3>? = idVec3.Companion.generateArray(2)
        ...
        operator fun set(v0: Float, v1: Float, v2: Float, v3: Float, v4: Float, v5: Float) {
            b.get(0).oSet(idVec3(v0, v1, v2))
            b.get(1).oSet(idVec3(v3, v4, v5))
        }

        //
        //public	final idVec3 	operator[]( final int index ) ;
        fun oSet(bounds: idBounds?) {
            b.get(0).oSet(bounds.b.get(0))
            b.get(1).oSet(bounds.b.get(1))
        }
        ...
        fun oGet(index1: Int, index2: Int): Float {
            return b.get(index1).oGet(index2)
        }

        fun oSet(index: Int, t: idVec3): idVec3 {
            return b.get(index).oSet(t)
        }

        fun oSet(x: Int, y: Int, value: Float): Float {
            return b.get(x).oSet(y, value)
        }

        // returns translated bounds
        fun oPlus(t: idVec3): idBounds? {
            return idBounds(b.get(0).oPlus(t), b.get(1).oPlus(t))
        }
        ...
        fun oMinus(a: idBounds?): idBounds? {
            assert(
                b.get(1).oGet(0) - b.get(0).oGet(0) > a.b.get(1).oGet(0) - a.b.get(0).oGet(0) && b.get(1)
                    .oGet(1) - b.get(0).oGet(1) > a.b.get(1).oGet(1) - a.b.get(0).oGet(1) && b.get(1).oGet(2) - b.get(0)
                    .oGet(2) > a.b.get(1).oGet(2) - a.b.get(0).oGet(2)
            )
            return idBounds(
                idVec3(
                    b.get(0).oGet(0) + a.b.get(1).oGet(0),
                    b.get(0).oGet(1) + a.b.get(1).oGet(1),
                    b.get(0).oGet(2) + a.b.get(1).oGet(2)
                ),
                idVec3(
                    b.get(1).oGet(0) + a.b.get(0).oGet(0),
                    b.get(1).oGet(1) + a.b.get(0).oGet(1),
                    b.get(1).oGet(2) + a.b.get(0).oGet(2)
                )
            )
        }
        ...
        fun oMinSet(a: idBounds?): idBounds? {
            ...
            b.get(0).oPluSet(a.b.get(1))
            b.get(1).oPluSet(a.b.get(0))
            return this
        }
        ...
        fun oMinSet(index: Int, t: idVec3): idVec3 {
            return b.get(index).oMinSet(t)
        }

        fun Compare(a: idBounds?): Boolean {                            // exact compare, no epsilon
            return b.get(0).Compare(a.b.get(0)) && b.get(1).Compare(a.b.get(1))
        }
        ...
        fun Compare(a: idBounds?, epsilon: Float): Boolean {    // compare with epsilon
            return b.get(0).Compare(a.b.get(0), epsilon) && b.get(1).Compare(a.b.get(1), epsilon)
        }

        override fun hashCode(): Int {
            var hash = 5
            hash = 11 * hash + Arrays.deepHashCode(b)
            return hash
        }
        ...
        override fun equals(obj: Any?): Boolean {
            ...
            return Arrays.deepEquals(b, other.b)
        }

        // inside out bounds
        fun Clear() {
            b.get(0).oSet(idVec3(idMath.INFINITY, idMath.INFINITY, idMath.INFINITY))
            b.get(1)
        ...
        fun GetCenter(): idVec3 {
            return idVec3(
                (b.get(1).oGet(0) + b.get(0).oGet(0)) * 0.5f,
                (b.get(1).oGet(1) + b.get(0).oGet(1)) * 0.5f,
                (b.get(1).oGet(2) + b.get(0).oGet(2)) * 0.5f
            )
        }
        ...
        fun GetRadius(): Float {
            ...
            i = 0
            while (i < 3) {
                b0 = Math.abs(b.get(0).oGet(i))
                b1 = Math.abs(b.get(1).oGet(i))
                total += if (b0 > b1) {
                    b0 * b0
                } else {
                    b1 * b1
        ...
        fun GetRadius(center: idVec3): Float {
            ...
            i = 0
            while (i < 3) {
                b0 = Math.abs(center.oGet(i) - b.get(0).oGet(i))
                b1 = Math.abs(b.get(1).oGet(i) - center.oGet(i))
                total += if (b0 > b1) {
                    b0 * b0
                } else {
                    b1 * b1
        ...
        fun GetVolume(): Float {
            return if (b.get(0).oGet(0) >= b.get(1).oGet(0) || b.get(0).oGet(1) >= b.get(1).oGet(1) || b.get(0)
                    .oGet(2) >= b.get(1).oGet(2)
            ) {
                0.0f
            } else (b.get(1).oGet(0) - b.get(0).oGet(0)) * (b.get(1).oGet(1) - b.get(0).oGet(1)) * (b.get(1)
                .oGet(2) - b.get(0).oGet(2))
        }

        // returns true if bounds are inside out
        fun IsCleared(): Boolean {
            return b.get(0).oGet(0) > b.get(1).oGet(0)
        }

        // add the point, returns true if the bounds expanded
        fun AddPoint(v: idVec3): Boolean {
            var expanded = false
            if (v.oGet(0) < b.get(0).oGet(0)) {
                b.get(0).oSet(0, v.oGet(0))
                expanded = true
            }
            if (v.oGet(0) > b.get(1).oGet(0)) {
                b.get(1).oSet(0, v.oGet(0))
                expanded = true
            }
            if (v.oGet(1) < b.get(0).oGet(1)) {
                b.get(0).oSet(1, v.oGet(1))
                expanded = true
            }
            if (v.oGet(1) > b.get(1).oGet(1)) {
                b.get(1).oSet(1, v.oGet(1))
                expanded = true
            }
            if (v.oGet(2) < b.get(0).oGet(2)) {
                b.get(0).oSet(2, v.oGet(2))
                expanded = true
            }
            if (v.oGet(2) > b.get(1).oGet(2)) {
                b.get(1).oSet(2, v.oGet(2))
                expanded = true
            }
            return expanded
        }
        ...
        fun AddBounds(a: idBounds?): Boolean {
            var expanded = false
            if (a.b.get(0).oGet(0) < b.get(0).oGet(0)) {
                b.get(0).oSet(0, a.b.get(0).oGet(0))
                expanded = true
            }
            if (a.b.get(0).oGet(1) < b.get(0).oGet(1)) {
                b.get(0).oSet(1, a.b.get(0).oGet(1))
                expanded = true
            }
            if (a.b.get(0).oGet(2) < b.get(0).oGet(2)) {
                b.get(0).oSet(2, a.b.get(0).oGet(2))
                expanded = true
            }
            if (a.b.get(1).oGet(0) > b.get(1).oGet(0)) {
                b.get(1).oSet(0, a.b.get(1).oGet(0))
                expanded = true
            }
            if (a.b.get(1).oGet(1) > b.get(1).oGet(1)) {
                b.get(1).oSet(1, a.b.get(1).oGet(1))
                expanded = true
            }
            if (a.b.get(1).oGet(2) > b.get(1).oGet(2)) {
                b.get(1).oSet(2, a.b.get(1).oGet(2))
                expanded = true
            }
            return expanded
        }
        ...
        fun Intersect(a: idBounds?): idBounds? {
            val n = idBounds()
            n.b.get(0).oSet(0, if (a.b.get(0).oGet(0) > b.get(0).oGet(0)) a.b.get(0).oGet(0) else b.get(0).oGet(0))
            n.b.get(0).oSet(1, if (a.b.get(0).oGet(1) > b.get(0).oGet(1)) a.b.get(0).oGet(1) else b.get(0).oGet(1))
            n.b.get(0).oSet(2, if (a.b.get(0).oGet(2) > b.get(0).oGet(2)) a.b.get(0).oGet(2) else b.get(0).oGet(2))
            n.b.get(1).oSet(0, if (a.b.get(1).oGet(0) < b.get(1).oGet(0)) a.b.get(1).oGet(0) else b.get(1).oGet(0))
            n.b.get(1).oSet(1, if (a.b.get(1).oGet(1) < b.get(1).oGet(1)) a.b.get(1).oGet(1) else b.get(1).oGet(1))
            n.b.get(1).oSet(2, if (a.b.get(1).oGet(2) < b.get(1).oGet(2)) a.b.get(1).oGet(2) else b.get(1).oGet(2))
            return n
        }
        ...
        fun Expand(d: Float): idBounds? {
            return idBounds(
                idVec3(b.get(0).oGet(0) - d, b.get(0).oGet(1) - d, b.get(0).oGet(2) - d),
                idVec3(b.get(1).oGet(0) + d, b.get(1).oGet(1) + d, b.get(1).oGet(2) + d)
            )
        }
        ...
        fun Translate(translation: idVec3): idBounds? { // return translated bounds
            return idBounds(b.get(0).oPlus(translation), b.get(1).oPlus(translation))
        }

        // translate this bounds
        fun TranslateSelf(translation: idVec3): idBounds? {
            b.get(0).oPluSet(translation)
            b.get(1).oPluSet(translation)
            return this
        }
        ...
        fun PlaneDistance(plane: idPlane?): Float {
            ...
            val d1: Float
            val d2: Float
            center.oSet(b.get(0).oPlus(b.get(1)).oMultiply(0.5f))
            d1 = plane.Distance(center)
            d2 = (Math.abs((b.get(1).oGet(0) - center.oGet(0)) * plane.Normal().oGet(0))
                    + Math.abs((b.get(1).oGet(1) - center.oGet(1)) * plane.Normal().oGet(1))
                    + Math.abs((b.get(1).oGet(2) - center.oGet(2)) * plane.Normal().oGet(2)))
            if (d1 - d2 > 0.0f) {
                return d1 - d2
            }
        ...
        fun ContainsPoint(p: idVec3): Boolean {
            return (p.oGet(0) >= b.get(0).oGet(0) && p.oGet(1) >= b.get(0).oGet(1) && p.oGet(2) >= b.get(0).oGet(2)
                    && p.oGet(0) <= b.get(1).oGet(0) && p.oGet(1) <= b.get(1).oGet(1) && p.oGet(2) <= b.get(1).oGet(2))
        }

        // includes touching
        fun IntersectsBounds(a: idBounds?): Boolean {
            return (a.b.get(1).oGet(0) >= b.get(0).oGet(0) && a.b.get(1).oGet(1) >= b.get(0).oGet(1) && a.b.get(1)
                .oGet(2) >= b.get(0).oGet(2)
                    && a.b.get(0).oGet(0) <= b.get(1).oGet(0) && a.b.get(0).oGet(1) <= b.get(1).oGet(1) && a.b.get(0)
                .oGet(2) <= b.get(1).oGet(2))
        }
        ...
        fun LineIntersection(start: idVec3, end: idVec3): Boolean {
            val ld = FloatArray(3)
            val center = idVec3(b.get(0).oPlus(b.get(1)).oMultiply(0.5f))
            val extents = idVec3(b.get(1).oMinus(center))
            ...
            return if (Math.abs(cross.oGet(1)) > extents.oGet(0) * ld[2] + extents.oGet(2) * ld[0]) {
                false
            } else Math.abs(cross.oGet(2)) <= extents.oGet(0) * ld[1] + extents.oGet(1) * ld[0]
        }
        ...
        fun RayIntersection(
            ...
            i = 0
            while (i < 3) {
                side = if (start.oGet(i) < b.get(0).oGet(i)) {
                    0
                } else if (start.oGet(i) > b.get(1).oGet(i)) {
                    1
                } else {
                    inside++
                    i++
                ...
                f = start.oGet(i) - b.get(side).oGet(i)
            ...
            return hit.oGet(ax1) >= b.get(0).oGet(ax1) && hit.oGet(ax1) <= b.get(1).oGet(ax1) && hit.oGet(ax2) >= b.get(
                0
            ).oGet(ax2) && hit.oGet(ax2) <= b.get(1).oGet(ax2)
        }
        ...
        fun FromTransformedBounds(bounds: idBounds?, origin: idVec3, axis: idMat3?) {
            ...
            while (i < 3) {
                rotatedExtents.oSet(
                    i, Math.abs(extents.oGet(0) * axis.oGet(0).oGet(i))
            ...
            b.get(0).oSet(center.oMinus(rotatedExtents))
            b.get(1).oSet(center.oPlus(rotatedExtents))
        }
        ...
        fun FromPoints(points: Array<idVec3>?, numPoints: Int) { // most tight bounds for a point set
            Simd.SIMDProcessor.MinMax(b.get(0), b.get(1), points, numPoints)
        }
        ...
        fun FromPointTranslation(point: idVec3, translation: idVec3) { // most tight bounds for a translation
            ...
            while (i < 3) {
                if (translation.oGet(i) < 0.0f) {
                    b.get(0).oSet(i, point.oGet(i) + translation.oGet(i))
                    b.get(1).oSet(i, point.oGet(i))
                } else {
                    b.get(0).oSet(i, point.oGet(i))
                    b.get(1).oSet(i, point.oGet(i) + translation.oGet(i))
                }
                i++
            }
        }
        ...
        fun FromBoundsTranslation(bounds: idBounds?, origin: idVec3, axis: idMat3?, translation: idVec3) {
            ...
            if (axis.IsRotated()) {
                ...
                b.get(0).oSet(bounds.oGet(0).oPlus(origin))
                b.get(1).oSet(bounds.oGet(1).oPlus(origin))
            }
            i = 0
            while (i < 3) {
                if (translation.oGet(i) < 0.0f) {
                    b.get(0).oPluSet(i, translation.oGet(i))
                } else {
                    b.get(1).oPluSet(i, translation.oGet(i))
                }
                i++
            }
        }
        ...
        fun FromPointRotation(point: idVec3, rotation: idRotation?) { // most tight bounds for a rotation
            ...
            if (Math.abs(rotation.GetAngle()) < 180.0f) {
                Bounds.BoundsForPointRotation(point, rotation)
            } else {
                radius = point.oMinus(rotation.GetOrigin()).Length()

                // FIXME: these bounds are usually way larger
                b.get(0).Set(-radius, -radius, -radius)
                b.get(1).Set(radius, radius, radius)
            }
        }
        ...
        fun FromBoundsRotation(bounds: idBounds?, origin: idVec3, axis: idMat3?, rotation: idRotation?) {
            ...
            val point = idVec3()
            if (Math.abs(rotation.GetAngle()) < 180.0f) {
                val rotationPointBounds: Array<idVec3> = idVec3.Companion.copyVec(
                    Bounds.BoundsForPointRotation(
                        axis.oMultiply(bounds.oGet(0)).oPlus(origin),
                        rotation
                    ).b
                )
                b.get(0).oSet(rotationPointBounds[0])
                b.get(1).oSet(rotationPointBounds[1])
                i = 1
                while (i < 8) {
                    ...
                    this.oPluSet(Bounds.BoundsForPointRotation(axis.oMultiply(point).oPlus(origin), rotation))
                    i++
                }
            } else {
        ...
        fun ToPoints(points: Array<idVec3>?) {
            for (i in 0..7) {
                points.get(i).oSet(0, b.get(i xor (i shr 1) and 1).oGet(0))
                points.get(i).oSet(1, b.get(i shr 1 and 1).oGet(1))
                points.get(i).oSet(2, b.get(i shr 2 and 1).oGet(2))
            }
        }

        fun ToSphere(): idSphere? {
            val sphere = idSphere()
            sphere.SetOrigin(b.get(0).oPlus(b.get(1)).oMultiply(0.5f))
            sphere.SetRadius(b.get(1).oMinus(sphere.GetOrigin()).Length())
            return sphere
        }
        ...
        fun AxisProjection(dir: idVec3, min: CFloat?, max: CFloat?) {
            ...
            val extents = idVec3()
            center.oSet(b.get(0).oPlus(b.get(1)).oMultiply(0.5f))
            extents.oSet(b.get(1).oMinus(center))
        ...
        override fun Write(): ByteBuffer? {
            ...
            buffer.put(b.get(0).Write()).put(b.get(1).Write()).flip()
            return buffer
        }

        companion object {
            val BYTES: Int = idVec3.Companion.BYTES * 2
